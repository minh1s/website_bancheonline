...
<body>
    ...
    <h2 class="text-center mb-4">Nhận xét & Đánh giá</h2>

    <!-- Form gửi review -->
    <div class="review-form mb-4">
        <input type="text" id="review-name" placeholder="Tên của bạn" class="form-control mb-2">
        ...
        <textarea id="review-text" rows="3" placeholder="Viết nhận xét..." class="form-control mb-2"></textarea>
        <button id="submit-review" class="btn btn-primary">Gửi nhận xét</button>
    </div>
