...
<body>
    ...
    <div class="review-form">
        ...
        <form id="userReview">
            ...
            <button type="submit" class="text-align">Gửi</button>
        </form>
    </div>
    ...
    <div class="reviews" id="reviewList">
        <div class="review-card">
            ...
            <div class="review-content">
                <h3>Anna Smith</h3>
                <p>⭐⭐⭐⭐⭐ "Absolutely love this place! The service was top-notch and the food was amazing. Highly recommend!"</p>
            </div>
        </div>
        ...
        <div class="review-card">
            ...
            <div class="review-content">
                <h3>John Doe</h3>
                <p>⭐⭐⭐⭐ "A truly luxurious experience. Every detail was perfect, and the atmosphere is so relaxing."</p>
            </div>
        </div>
        ...
        <div class="review-card">
            ...
            <div class="review-content">
                <h3>Emily Johnson</h3>
                <p>⭐⭐⭐⭐⭐ "The best customer service I’ve ever experienced. I felt so welcomed and valued!"</p>
            </div>
        </div>
    </div>
