...
<head>
    ...
    @import url('https://fonts.googleapis.com/css2?family=Dancing+Script:wght@500&family=Comic+Neue:wght@700&display=swap');
...
<footer class="footer">
  <div class="footer-top">
    <div class="footer-left">
      <img src="logo.png" alt="Chè Liên" class="footer-logo">
      <p class="footer-thank">Cảm ơn bạn đã đến với<br><strong>Chè Liên</strong></p>
    </div>
  ...
  <div class="footer-bottom">
    ...
    <p class="footer-copy">
      Copyright © 2019 Chè Liên | Được phát triển bởi 
      <a href="#">Tekup.vn</a>
    </p>
  </div>
</footer>
