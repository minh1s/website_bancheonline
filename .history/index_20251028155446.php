...
<body>
    ...
    <div id="menu" class="container text-center">
        <h2 class="text-center my-4">NHỮNG MÓN BÁN CHẠY NHẤT 2025</h2>
    ...
    <!---------------------CHI NHÁNH CỬA HÀNG------------------------->
    <div>
        <strong class="text-center my-4">Hệ thống cửa hàng</strong>
        <ul>
            <li>
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            ...
            <p class="footer-copy">
                Copyright © 2019 Chè Anh Em Cây Khế | Được phát triển bởi
                <a href="#">Team4AE.vn</a>
            </p>
        </div>
    </footer>
