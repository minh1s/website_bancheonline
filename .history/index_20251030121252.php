...
<div id="reviews" class="container">
    ...
    <div class="review-form">
        ...
        <textarea id="review-text" rows="3" placeholder="Viết nhận xét..."></textarea>
        <button id="submit-review">Gửi nhận xét</button>
    </div>
    ...
    <div id="review-list">
        ...
        <div class="review-card">
            ...
            <p>Sản phẩm rất ngon, giao hàng nhanh và đóng gói cẩn thận. Chắc chắn sẽ ủng hộ lần sau!</p>
        </div>

        <div class="review-card">
            <h5>Trần Bình</h5>
            <div class="rating">★★★★</div>
            <p>Chè thái ngon, hoa quả tươi, vị vừa ăn. Mình thích nhất phần sữa chua mịn.</p>
        </div>

        <div class="review-card">
            <h5>Phạm Linh</h5>
            <div class="rating">★★★★★</div>
            <p>Dịch vụ tốt, nhân viên thân thiện, mình rất hài lòng. Sẽ giới thiệu bạn bè mua thử!</p>
        </div>
    </div>
</div>
