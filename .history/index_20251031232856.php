...
function openModal() {
  ...
  history.replaceState({}, '', '?page=dangnhap');
}
...
if (footerLoginBtn) footerLoginBtn.addEventListener('click', (e) => { e.preventDefault(); openModal(); });
...
if (new URLSearchParams(window.location.search).get('page') === 'dangnhap') {
  modal.style.display = 'flex';
}
